...
Saya sudah mencoba pakai data dengan menyertakan link github, tapi gabisa terus, makanya pakai file lokal saja
...
fore.koyck
mape.koyck <- MAPE(fore.koyck$forecasts, test$o3)
...
cons_lm2 <- dynlm(AQI ~ o3 + L(o3, 1:2) + L(AQI, 1:13), data = train.ts)
```
